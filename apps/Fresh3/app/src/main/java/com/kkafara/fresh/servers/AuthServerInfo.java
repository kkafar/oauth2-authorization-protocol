...
public class AuthServerInfo {
  public static final String AUTHORITY = "bd6a-91-123-181-221.ngrok.io";
  ...
  public static final String ENDPOINT_NAME_CHECK_ADMIN_REVOKE = "checkTokensAvailable";
  ...
  public static final String ENDPOINT_ADDRESS_CHECK_ADMIN_REVOKE = HTTP_ADDRESS + "/" + ENDPOINT_NAME_CHECK_ADMIN_REVOKE;
}
